                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <a href="/add-banner" class="btn btn-secondary btn-round">Add Banner Ads Trip</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <thead class="bg-primary text-white">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <img src="{{ asset('uploads/img/banner/' . $banner->banner_assets) }}" alt="{{ $banner->description }}" width="50"></td>
                                                    
                                                    <td>{{ $banner->description}}</td>

                                                    <td class="text-center">
                                                        <div style="display: flex; gap: 10px;">
                                                        <form action="{{ route('banner.edit', $banner->bannerID) }}" method="GET" style="display:inline;">
                                                            @csrf
                                                            <button type="submit" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                        </form>
                                                        <form action="{{ route('banner.delete', $banner->bannerID) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
