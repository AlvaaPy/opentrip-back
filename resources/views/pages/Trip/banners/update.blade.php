                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('banner.update', $bannerAds->bannerID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')

                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="banner_assets" class="form-label">Picture</label>
                                                <input type="file" class="form-control rounded" id="banner_assets" name="banner_assets" accept="image/png,image/jpg,image/webp,image/jpeg">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="description" class="form-label">Nama Trip</label>
                                                <input type="text" class="form-control rounded" id="description" name="description" value="{{ $bannerAds->description }}" required maxlength="255">
                                            </div>
                                        </div>
                                        ...
                                        <a href="{{ route('trip.banner') }}" class="btn btn-secondary w-100 mt-2"> Cancel</a>
                                    </form>
                                </div>
