                            ...
                            <div class="card full-height">
                                <div class="card-body">
                                    ...
                                    <form action="/add-banner" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12 mb-3"> <!-- Mengubah col-md-10 menjadi col-md-12 -->
                                                <label for="banner_assets" class="form-label">Picture</label>
                                                <input type="file" class="form-control rounded" id="banner_assets" name="banner_assets" accept="image/png,image/jpg,image/webp,image/jpeg" required>
                                                <p class="text-danger mb-0">*png/jpg/jpeg/webp | max 10MB</p>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12 mb-3"> <!-- Mengubah col-md-15 menjadi col-md-12 -->
                                                <label for="description" class="form-label">Deskripsi Banner</label>
                                                <textarea class="form-control rounded" id="description" name="description" rows="4" required></textarea> <!-- Menambahkan rows untuk meningkatkan tinggi textarea -->
                                            </div>
                                        </div>
