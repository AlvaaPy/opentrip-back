                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('galery.update', $assets->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control rounded" id="tripID" name="tripID" value="{{ old('tripID', $assets->tripID) }}" readonly>
                                            </div>
                                        </div>
