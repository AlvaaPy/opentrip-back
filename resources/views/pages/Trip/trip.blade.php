                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="#" class="btn btn-secondary btn-round">Add Package Trip</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>1001</td>
                                                    <td>Kuta, Bali</td>
                                                    <td>Enjoy the beautiful beaches of Bali</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>1002</td>
                                                    <td>Malioboro, Yogyakarta</td>
                                                    <td>Explore the cultural city of Yogyakarta</td>
                                                    <td>Malioboro</td>
                                                    <td>$300</td>
                                                    <td>2024-11-15</td>
                                                    <td>2024-11-20</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>1003</td>
                                                    <td>Lombok Island</td>
                                                    <td>Discover the serenity of Lombok</td>
