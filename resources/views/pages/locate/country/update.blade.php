                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                ...
                                <div class="card-title fw-bold mb-4">Update Package Trip</div>
                                    <form action="{{ route('country.update', $country->countryID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" class="form-control rounded" id="country_name" name="country_name" value="{{ $country->country_name }}" required maxlength="255">
                                            </div>
                                        </div>
                                        </div>
