                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                ...
                                <div class="card-title fw-bold mb-4">Update Package Trip</div>
                                    <form action="{{ route('province.update', $province->provinceID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" class="form-control rounded" id="countryID" name="countryID" value="{{ $province->countryID }}" required maxlength="255" readonly>
                                            </div>
                                        <div class="col-md-12 mb-3">
                                                <label for="province_name" class="form-label">Country Name</label>
                                                <input type="text" class="form-control rounded" id="province_name" name="province_name" value="{{ $province->province_name }}" required maxlength="255">
                                            </div>
                                        </div>
                                        </div>
