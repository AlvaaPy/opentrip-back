                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="/add-galery-rental" class="btn btn-secondary btn-round">Add Galery Trip</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead class="bg-primary text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center">Nama Kendaraan</th> <!-- Nama Trip ditambahkan -->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $images->images_rental_id }}</td>
                                                    <td>{{ $images->rentals->rentalID }}</td>
                                                    <td>{{ $images->rentals->nama_kendaraan }}</td>
                                                    <td>
