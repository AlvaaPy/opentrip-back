                    ...
                    <div class="row mt--2">
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    <div class="card-title fw-bold">Rental Kendaraan</div>
                                    <div class="card-category">Data management for Rental Kendaraan</div>
                                        ...
                                        <table id="package-trip-table" class="table table-bordered">
                                            <thead class="bg-primary text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center">Kapasitas Kendaraan</th>
                                                    <th class="text-center">Kapasitas Bagasi</th>
                                                    <th class="text-center">Umur Kendaraan</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $rental->kapasitas_kendaraan }} Orang</td>
                                                    <td>{{ $rental->kapasitas_bagasi }} Kg</td>
                                                    <td>{{ $rental->umur_kendaraan }} Tahun</td>
                                                    <td>{{ $rental->jenis_kendaraan }}</td>
