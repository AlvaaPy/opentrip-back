                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Create Sewa Kendaraan</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    <div class="card-title fw-bold mb-4">Tambah Sewa Kendaraan</div>
                                    <form action="{{ route('rental.create') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="nama_kendaraan" class="form-label">Nama Kendaraan</label>
                                                <input type="text" class="form-control rounded" id="nama_kendaraan" name="nama_kendaraan" required maxlength="255">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="kapasitas_kendaraan" class="form-label">Kapasitas Kendaraan</label>
                                                <input type="number" class="form-control rounded" id="kapasitas_kendaraan" name="kapasitas_kendaraan" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="kapasitas_bagasi" class="form-label">Kapasitas Bagasi</label>
                                                <input type="number" class="form-control rounded" id="kapasitas_bagasi" name="kapasitas_bagasi" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="umur_kendaraan" class="form-label">Umur Kendaraan</label>
                                                <input type="number" class="form-control rounded" id="umur_kendaraan" name="umur_kendaraan" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="jenis_kendaraan" class="form-label">Jenis Kendaraan</label>
                                                <select class="form-control rounded" id="jenis_kendaraan" name="jenis_kendaraan" required>
                                                    <option value="metic">Metic</option>
                                                    <option value="automatic">Automatic</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="dengan_supir" class="form-label">Dengan Supir</label>
                                                <select class="form-control rounded" id="dengan_supir" name="dengan_supir" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control rounded" id="harga" name="harga" required min="0">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="foto" class="form-label">Foto</label>
                                                <input type="file" class="form-control rounded" id="foto" name="foto" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label for="deskripsi" class="form-label">Deskripsi (Opsional)</label>
                                                <textarea class="form-control rounded" id="deskripsi" name="deskripsi"></textarea>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-lg w-100">
                                            <i class="fas fa-paper-plane me-2"></i> Tambah Sewa Kendaraan
                                        </button>
                                        <a href="{{ route('rental.index') }}" class="btn btn-secondary w-100 mt-2">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
