                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Add New Voucher</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    <div class="card-title fw-bold mb-4">Create Voucher</div>
                                    <form action="/Add-Voucher" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control rounded" id="voucher_code" name="voucher_code" placeholder="Enter voucher code" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control rounded" id="fixed_discount" name="fixed_discount" placeholder="Enter fixed discount">
                                            </div>

                                            <!-- Percentage Discount -->
                                            <div class="col-md-6 mb-3">
                                                <label for="percentage_discount" class="form-label">Percentage Discount (%)</label>
                                                <input type="number" class="form-control rounded" id="percentage_discount" name="percentage_discount" placeholder="Enter percentage discount" max="100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-control rounded" id="tripID" name="tripID" disabled>
                                                    <option value="" disabled selected>-- Select Trip --</option>
                                                    @foreach($Vouchers as $trip)
                                                    <option value="{{ $trip->tripID }}">{{ $trip->namaTrip }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control rounded" id="valid_from" name="valid_from" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control rounded" id="valid_until" name="valid_until" value="{{ old('valid_until') }}" required>
